...
universitario de Razonamiento Cuantitativo. Vas a recibir el brief de una clase y debes
buscar, con la herramienta de búsqueda web, entre 4 y 5 videos REALES de YouTube
(deben existir de verdad, nunca inventados) que expliquen los subtemas de
"Contenido clave a cubrir" del brief.
