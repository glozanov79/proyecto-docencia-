...
SYSTEM_PROMPT = """Eres un diseñador de talleres de matemáticas/estadística para un curso
universitario de Razonamiento Cuantitativo. Vas a recibir el brief de una clase y debes
diseñar un taller de 8 a 10 ejercicios para que los estudiantes practiquen en Moodle.
